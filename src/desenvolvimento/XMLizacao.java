...
public class XMLizacao {
	...
	public static void main(String[] args) {
		...
		String regexLeis = "(( Decreto| \\QDecreto-Lei\\E| Decreto Lei| Decreto Lei Federal| Decreto-Lei Federal| Lei Federal| Lei Complementar| Lei Complementar Federal| Lei| ResoluÁ„o| Emenda Constitucional| Ad Referendum| OfÌcio| Parecer| Parecer Conjunto| Portaria Conjunta| Portaria| Ato( DeclaratÛrio)?| Termo| Ajuste| Ata)( do| da)?[A-Z \\Q/-\\E]{0,16}((( n∫| n∞)? (\\d{1,2}\\.\\d{3}|\\d{3}|\\d{2}|\\d{2,4}/\\d{2,4}[A-Z\\Q/ -\\E]{0,10}))?(,)?((( de| em)? (\\d{1,2})(∞|∫)?( de |[\\Q./-\\E])([a-zÁA-Z«]{4,9}|\\d{1,2}[\\Q./-\\E]))?( de )?(\\d{4}))?))(,|\\Q.\\E|;|:|\\Q -\\E| [a-zÈ‡·ÌÛ˙Í‚Ù])";
		String regexDoc = "(( CÛdigo(s)?| ConstituiÁ(„o|ıes)| Estatuto(s)?| OrÁamento(s)?| Termo(s)?| Documento(s)?| Cadastro(s)?| Quadro(s)?| DeclaraÁ(„o|ıes)| Certificado(s)?| Regimento(s)?| Regulamento(s)?| Regime(s)?| Ato(s)?| Ata(s)?| Termo(s)?| Orde(m|ns) Banc·ria(s)?| Di·rio Oficial (do Estado|da Uni„o)| Contrato(s)?| BalanÁo(s)?| Despesa(s)?| Nota(s)?| ResoluÁ(„o|ıes)| Anexo(s)?| Lei(s)?) ((e )?(de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |no |nos |nas |na |para |com |com os |com as )?[A-Z¬¡… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)(, | - | )?)+(\\s*(-|/)\\s*[A-Z][A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]+)*)(,|<|\\Q.\\E|;|:| [a-zÈ‡·ÌÛ˙Í‚Ù])";
		...
		String regexGrupo = "(( Comiss(„o|ıes)| ComitÍ(s)?| Grupo(s)?| Grupamento(s)?| Conselho(s)?) ((e )?(de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |no |nos |nas |na |para |com |com os |com as )?[A-Z¬¡… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)(, | - | )?)+(\\s*(-|/)\\s*[A-Z][A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]+)*)(,|<|\\Q.\\E|;|:| [a-zÈ‡·ÌÛ˙Í‚Ù])";
		String regexUnidade = "(( (?i)Unidade) ((e )?(de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |no |nos |nas |na |para |com |com os |com as )?[A-Z¬¡… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)(, | - | )?)+(\\s*(-|/)\\s*[A-Z][A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]+)*)(,|<|\\Q.\\E|;|:| [a-zÈ‡·ÌÛ˙Í‚Ù])"; 
		String regexSecretaria = "(( (?i)(Secretaria)| (?i)(Gabinete)) ((e )?(de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |no |nos |nas |na |para |com |com os |com as )?[A-Z¬¡¿… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)(, | - | )?)+(\\s*(-|/)\\s*[A-Z][A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]+)*)(,|\\Q.\\E|;|:|( )?<| [a-zÈ‡·ÌÛ˙Í‚Ù])";
		...
		String regexServico = "( ServiÁo ((e )?(de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |no |nos |nas |na |para |com |com os |com as )?[A-Z¬¡¿… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)(, | - | )?)+(\\s*(-|/)\\s*[A-Z][A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]+)*)(,|\\Q.\\E|;|:|( )?<| [a-zÈ‡·ÌÛ˙Í‚Ù])";
		String regexProgProj = "(( Regime(s)?| Projeto(s)?| Programa(s)?| Fundo(s)?| PolÌtica(s)?| GratificaÁ(„o|ıes)| ConsolidaÁ(„o|ıes)| Plano(s)?| Regulamento(s)?| ConvÍnio(s)?| Financiamento(s)?) ((e )?(de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |no |nos |nas |na |para |com |com os |com as )?(<CAR>|<ORG>)?[A-Z¬¡¿… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)(\\. |, | - | )?(</CAR>|</ORG>)?)+(\\s*(-|/)\\s*[A-Z][A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]+)*| Simples Nacional)(,|\\Q.\\E|;|:|<| [a-zÈ‡·ÌÛ˙Í‚Ù])";
		String regexSistema = "( (?i)(Sistema) ((e )?(de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |no |nos |nas |na |para |com |com os |com as )?(\\Qe-\\E)?[A-Z¬¡¿… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)(\\. |, | - | )?)+(\\s*(-|/)\\s*[A-Z][A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]+)*)(,|\\Q.\\E|;|:|( )?<| [a-zÈ‡·ÌÛ˙Í‚Ù])";
		String regexEvento = "(( [IVX]{1,5})?( ConferÍncia| Evento| Show| Concerto| SimpÛsio| Debate| FÛrum| Estudo) ((e )?(de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |no |nos |nas |na |para |com |com os |com as )?[A-Z¬¡… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)(\\. |, | - | )?)+(\\s*(-|/)\\s*[A-Z][A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]+)*)(,|\\Q.\\E|;|:|<| [a-zÈ‡·ÌÛ˙Í‚Ù])";
		...
		String regexImp = "(( Õndice| Taxa| Imposto| Tributo) (((e )?(de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |no |nos |nas |na |para |com |com os |com as )?[A-Z¬¡… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)(\\. |, | - | )?))+(\\s*(-|/)\\s*[A-Z]([A-Z¬√¡… Õ”‘’⁄«&]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙&]+))*)(,|\\Q.\\E|;|:)";
		...
		for (int i = 0; i < anosDecretos.length; i++){
			...
			for (int j = 0; j < arquivos[i].length; j++){
				...
				try {
					...
					while (matcher.find()){
						//System.out.println(nomeArquivo);
						if (!(matcher.group(1).contains("Unidade Federativa")||matcher.group(1).contains("Unidade da FederaÁ„o"))){
							entreTags = matcher.group(1);
