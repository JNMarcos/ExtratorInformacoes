...
public class XMLizacao {
	...
	public static void main(String[] args) {
		...
		String regexLeis = "(( Decreto| \\QDecreto-Lei\\E| Decreto Lei| Decreto Lei Federal| Decreto-Lei Federal| Lei Federal| Lei Complementar| Lei Complementar Federal| Lei| ResoluÁ„o| Emenda Constitucional| Ad Referendum| OfÌcio| Parecer| Parecer Conjunto| Portaria Conjunta| Portaria| Ato DeclaratÛrio| Termo| Ordem Banc·ria| Ordens Banc·rias| Di·rio Oficial (do Estado|da Uni„o))([A-Z \\Q/-\\E]{0,16})(( (n∫|n∞) (\\d{1,3}\\.\\d{3}|\\d{3}|\\d{2}|\\d{2,4}/\\d{2,4}[A-Z/ -]{0,10}))?(,| )((( de|de| em)? (\\d{1,2})(∞|∫)? de ([a-zÁA-Z«]{4,9}))? de (\\d{4}))?)( da ConstituiÁ„o Estadual)?)(,|\\Q.\\E|;|:| [a-z])";
		String regexDinheiro = " R\\$\\s+[0-9.]+,\\d{2}";
		String regexPorcentagem = " [0-9]+(,\\d{1,})?( )?%";
//[0-9A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]*
		String regexEmpresa = "( (a|‡|pela|da|da mesma|denominaÁ„o atual È|atualmente denominada|antiga)( empresa| EMPRESA| Empresa)?( (([0-9A-Z¬¡… Õ”‘⁄&]|de |da |do |das |dos )[0-9A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]*[\\Q-., \\E]{1,3})+(\\QLTDA.\\E|LTDA)( ME)?(\\s*(-| |/)\\s*[A-Z]([A-Z¬√¡… Õ”‘’⁄«&]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙&]+))*))(,|\\Q.\\E|;|:| [a-z]|, [a-z])";
		String regexEmpresa2 = "( (a|‡|pela|da|da mesma|denominaÁ„o atual È|atualmente denominada|antiga)( empresa| EMPRESA| Empresa)?( (([0-9A-Z¬¡… Õ”‘⁄&]|de |da |do |das |dos )[0-9A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]*[\\Q-., \\E]{1,3})+(\\QS/A\\E|\\QS.A.\\E|\\QS.A\\E)(\\s*(-| |/)\\s*[A-Z]([A-Z¬√¡… Õ”‘’⁄«&]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙&]+))*))(,|\\Q.\\E|;|:| [a-z])";
		String regexEmpresa3 = "( (a|‡|pela|da|da mesma|denominaÁ„o atual È|atualmente denominada)( empresa| EMPRESA| Empresa)( (([0-9A-Z¬¡… Õ”‘⁄&]|de |da |do |das |dos )[0-9A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]*[\\Q-., \\E]{1,3})+(\\s*(-| |/)\\s*[A-Z]([A-Z¬√¡… Õ”‘’⁄«&]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙&]+))*))(,|\\Q.\\E|;|:)";
		String regexEmpresa4 = "( (a|‡|pela|da|da mesma|denominaÁ„o atual È|atualmente denominada)( empresa| EMPRESA| Empresa)( (([0-9A-Z¬¡… Õ”‘⁄&]|de |da |do |das |dos )[0-9A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]*[\\Q-., \\E]{0,3})+))(,|\\Q.\\E|;|:| [a-z])";
		String regexOrgao = "(( FundaÁ„o| EscritÛrio| ”rg„o| OrganizaÁ„o| Secretaria(s)?| Instituto| Departamento| Procuradoria| AgÍncia| Comiss„o| Junta| Assembleia| C‚mara| ConsÛrcio| Defensoria| Tribunal| Companhia| Controladoria| Gabinete| GerÍncia| ComitÍ| Contadoria| Unidade| Grupo| Central| Conselho| Banco| PolÌcia)( (e )?(de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |no |nos |nas |na |para )?[A-Z¬¡… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)[\\Q-,\\E]{0,3})+(\\s*(-| |/)\\s*[A-Z][A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]+)*)(,|\\Q.\\E|;|:)";
		String regexProgProj = "(( Projeto(s)?| Programa(s)?| Fundo| PolÌtica(s)?| GratificaÁ„o| ConsolidaÁ„o| Sistema(s)?| Plano(s)?| Regulamento(s)?| ConvÍnio(s)?| Financiamento(s)?| OrÁamento(s)?| Lei(s)?| Quadro(s)?) ((e )?(de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |no |nos |nas |na |para )?[A-Z¬¡¿… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)[\\Q-., /\\E]{1,3})+(\\s*(-| |/)\\s*[A-Z][A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]+)*)(,|\\Q.\\E|;|:|<)";
		String regexData = " (\\d{1,2})(∞|∫)? de ([a-zÁA-Z«]{4,9}) de (\\d{4})";
		String regexIntervaloData = " <DAT>[0-9A-Za-z ∫∞]+</DAT> a <DAT>[0-9A-Za-z ∫∞]+</DAT>|\\d{1,2}(∞|∫)?[ A-Za-z] a <DAT>[0-9A-Za-z ∫∞]+</DAT>";
		String regexInfoEmp = " estabelecida n(a|o) ([0-9A-Za-zÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«\\Q() ,∫∞™-.;/'\"\\E]+ CNPJ(/MF)? n(∫|∞) \\d{2}\\.\\d{3}\\.\\d{3}/\\d{4}-\\d{2} e CACEPE n(∞|∫) \\d{7}\\-\\d{2})";
		String regexCNPJ = " CNPJ(/MF)?( \\d{2}\\.\\d{3}\\.\\d{3}(/\\d{4}-\\d{2})?)";
		String regexIE = " (InscriÁ„o Estadual|IE)( \\d{1,3}\\.\\d{3}\\.\\d{3}(\\-\\d{1,2}|\\.\\d{3})?)";
		...
		for (int i = 0; i < anosDecretos.length; i++){
			...
			for (int j = 0; j < arquivos[i].length; j++){
				...
				try {
						...
						//System.out.println(entreTags);
						 ...
						 if (matcher.group(10) == null && matcher.group(6) != null){
							...
							textoModificado += " data=" + (matcher.group(13).length() < 2? "0" + matcher.group(13) : matcher.group(13))
									+ "-" + numeracaoMeses.get(matcher.group(15).toLowerCase()) + "-" + matcher.group(16);
							...
							textoModificado += " numeracao=" + matcher.group(8);
							textoModificado += " ano=" + matcher.group(16);
						}

						textoModificado+= ">" + (matcher.group(10) != null? matcher.group(1).trim(): matcher.group(1).replace(",","").trim()) + "</" + tiposDocumentos.get(matcher.group(2).trim()) + ">" + ((matcher.group(9) != null? "": ","));
						decretoSaida = decretoSaida.replaceFirst("\\Q"+entreTags+"\\E", textoModificado);
					}
					...
					while (matcher.find()){
						entreTags = matcher.group(2);
						textoModificado = " <IE>" + matcher.group(2).trim() + "</IE>";
						decretoSaida = decretoSaida.replaceFirst("\\Q" + entreTags +"\\E", textoModificado);
					}
					...
					while (matcher.find()){
						entreTags = matcher.group(2);
						textoModificado = " <CNPJ>" + matcher.group(2).trim() + "</CNPJ>";
						decretoSaida = decretoSaida.replaceFirst("\\Q" + entreTags +"\\E", textoModificado);
					}
