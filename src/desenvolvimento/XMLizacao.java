...
public class XMLizacao {
	...
	public static void main(String[] args) {
		...
		String regexLeis = "( Decreto| \\QDecreto-Lei\\E| Lei Federal| Lei Complementar| Lei| Resolução)( nº (\\d{2,3}\\.\\d{3}|\\d{3}), de (\\d{1,2}) de ([a-zçA-ZÇ]{4,9}) de (\\d{4}))( da Constituição Estadual)?";
