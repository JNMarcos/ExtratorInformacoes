...
public class XMLizacao {
	...
	public static void main(String[] args) {
		...
		String regexDoc = "(( |\"|\\()(Manua(l|is)|Caderno(s)?|CÛdigo(s)?|ConstituiÁ(„o|ıes)|Estatuto(s)?|OrÁamento(s)?|Termo(s)?|Documento(s)?|Cadastro(s)?|Quadro(s)?|DeclaraÁ(„o|ıes)|Certificado(s)?|Regimento(s)?|Regulamento(s)?|Regime(s)?|Ato(s)?|Ata(s)?|Termo(s)?|Orde(m|ns) Banc·ria(s)?|Di·rio Oficial|Registro(s)?|Contrato(s)?|BalanÁo(s)?|Despesa(s)?|Nota(s)?|ResoluÁ(„o|ıes)|Anexo(s)?|Memoria(l|is)) ((e )?(de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |para |com |com os |com as )?[A-Z¬¡… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)*(, | - | )?)+(\\s*(-|/)\\s*[A-Z][A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&-\\E]+)*)\\s*(,|<|\\Q.\\E|;|:|\"|\\Q)\\E| [a-zÈ‡·ÌÛ˙Í‚Ù]|  )";
		...
		String regexEvento = "(( |\"|\\()([IVX]{1,5} |\\d{1,3}(∫|∞|™) )?(ConferÍncia|Evento|Show|Concerto|SimpÛsio|Debate|FÛrum|Estudo|Copa) ((e )?(de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |no |nos |nas |na |para |com |com os |com as )?[A-Z¬¡… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)(\\. |, | - | )?)+(\\d{4})?(\\s*(-|/)\\s*[A-Z][A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]+)*)\\s*(,|<|\\Q.\\E|;|:|\"|\\Q)\\E| [a-zÈ‡·ÌÛ˙Í‚Ù])";
