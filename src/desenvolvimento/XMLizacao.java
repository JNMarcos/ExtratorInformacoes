...
public class XMLizacao {
	...
	public static void main(String[] args) {
		...
		String regexLeis = "(( Decreto| \\QDecreto-Lei\\E| Decreto Lei| Decreto Lei Federal| Decreto-Lei Federal| Lei Federal| Lei Complementar| Lei Complementar Federal| Lei| ResoluÁ„o| Emenda Constitucional| Ad Referendum| OfÌcio| Parecer| Parecer Conjunto| Portaria Conjunta| Portaria| Ato( DeclaratÛrio)?| Termo| Ordem Banc·ria| Ajuste| Ordens Banc·rias| Di·rio Oficial (do Estado|da Uni„o)| Ata)([A-Z \\Q/-\\E]{0,16})((( n∫| n∞)? (\\d{1,2}\\.\\d{3}|\\d{3}|\\d{2}|\\d{2,4}/\\d{2,4}[A-Z\\Q/ -\\E]{0,10}))?(,)?((( de| em)? (\\d{1,2})(∞|∫)?( de |[\\Q./-\\E])([a-zÁA-Z«]{4,9}|\\d{1,2}[\\Q./-\\E]))?( de )?(\\d{4}))?)( da ConstituiÁ„o Estadual)?)(,|\\Q.\\E|;|\\Q:\\E| [a-z]|\\))";
		String regexDinheiro = " R\\$\\s+[0-9.]+,\\d{2}";
		String regexPorcentagem = " [0-9]+(,\\d{1,})?( )?%";
		//[\\Q-., \\E]{0,3}
		String regexEmpresa = "( (a|‡|pela|da|da mesma|denominaÁ„o atual È|atualmente denominada|antiga|[IXV]{1,5} -)( empresa| EMPRESA| Empresa)?( (([0-9A-Z¬¡… Õ”‘⁄&]|de |da |do |das |dos )[0-9A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]*[\\Q-., \\E]{1,3})+(\\QLTDA.\\E|LTDA)( ME)?(\\s*(-| |/)\\s*[A-Z]([A-Z¬√¡… Õ”‘’⁄«&]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙&]+))*))(,|\\Q.\\E|;|:| [a-z]|, [a-z])";
		String regexEmpresa2 = "( (a|‡|pela|da|da mesma|denominaÁ„o atual È|atualmente denominada|antiga|[IXV]{1,5} -)( empresa| EMPRESA| Empresa)?( (([0-9A-Z¬¡… Õ”‘⁄&]|de |da |do |das |dos )[0-9A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]*[\\Q-., \\E]{1,3})+(\\QS/A\\E|\\QS.A.\\E|\\QS.A\\E)(\\s*(-| |/)\\s*[A-Z]([A-Z¬√¡… Õ”‘’⁄«&]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙&]+))*))(,|\\Q.\\E|;|:| [a-z])";
		...
		//N√O EXCLUIR ESSA COISA
		//String regexOrgao = "(( FundaÁ(„o|ıes)| EscritÛrio(s)?| ”rg„o(s)?| OrganizaÁ(„o|ıes)| Secretaria(s)?| Instituto(s)?| Departamento(s)?| Procuradoria(s)?| AgÍncia(s)?| Comiss(„o|ıes)?| Junta(s)?| Assembleia(s)?| C‚mara(s)?| ConsÛrcio(s)?| Defensoria(s)?| Tribuna(l|is)| Companhia(s)?| Controladoria(s)?| Gabinete(s)?| GerÍncia(s)?| ComitÍ(s)?| Contadoria(s)?| InteligÍncia(s)?| Unidade(s)?| Grupo(s)?| Grupamento(s)?| Corpo(s)?| Centra(l|is)| Conselho(s)?| Banco(s)?| PolÌcia(s)?| Diretoria(s)?| Receita| Delegacia(s)?| Autarquia(s)?| CoordenaÁ(„o|ıes)| Assessoria(s)?| Apoio(s)?) ((e )?(de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |no |nos |nas |na |para )?[A-Z¬¡… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)[\\Q-., \\E]{0,3})+(\\s*(-|/)\\s*[A-Z][A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]+)*)(,|<|\\Q.\\E|;|:| [a-z])";
		String regexOrgao = "(( AgÍncia| FundaÁ„o| AdministraÁ„o| Companhia| ConservatÛrio| ConsÛrcio| Coordenadoria| Corpo| Departamento| FundaÁ„o| Instituto| Junta| LaboratÛrio| PolÌcia| SuperintendÍncia) ((e )?(de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |no |nos |nas |na |para )?[A-Z¬¡… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)(, | - | )?)+(\\s*(-|/)\\s*[A-Z][A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]+)*)(,|<|\\Q.\\E|;|:| [a-z])";
		String regexOrgao2 = "( AD Diper| Adagro| Arquivo| Porto Digital| Porto de Recife| ProRural| Complexo Industrial Portu·rio| Universidade de Pernambuco| Pernambuco ParticipaÁıes e Investimento S/A( - Perpart)?| ServiÁo de ProteÁ„o ao Consumidor( - PROCON)?)";
		String regexGrupo = "";
		String regexSecretaria = "(( (?i)(Secretaria)| (?i)(Gabinete)) ((e )?(de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |no |nos |nas |na |para )?[A-Z¬¡¿… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)(, | - | )?)+(\\s*(-|/)\\s*[A-Z][A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]+)*)(,|\\Q.\\E|;|:|( )?<| [a-zÈ‡·ÌÛ˙Í‚Ù])";
		...
		String regexServico = "( ServiÁo ((e )?(de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |no |nos |nas |na |para )?[A-Z¬¡¿… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)(, | - | )?)+(\\s*(-|/)\\s*[A-Z][A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]+)*)(,|\\Q.\\E|;|:|( )?<| [a-z])";
		String regexProgProj = "(( Regime(s)?| Projeto(s)?| Programa(s)?| Fundo(s)?| PolÌtica(s)?| GratificaÁ(„o|ıes)| ConsolidaÁ(„o|ıes)| Plano(s)?| Regulamento(s)?| ConvÍnio(s)?| Financiamento(s)?| Quadro(s)?| OrÁamento(s)?| DeclaraÁ(„o|ıes)| Certificado(s)?) ((e )?(de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |no |nos |nas |na |para )?(<CAR>|<ORG>)?[A-Z¬¡¿… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)(\\. |, | - | )?(</CAR>|</ORG>)?)+(\\s*(-|/)\\s*[A-Z][A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]+)*| Simples Nacional)(,|\\Q.\\E|;|:|<| [a-z])";
		String regexSistema = "( Sistema ((e )?(de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |no |nos |nas |na |para )?[A-Z¬¡¿… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)(\\. |, | - | )?)+(\\s*(-|/)\\s*[A-Z][A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]+)*)(,|\\Q.\\E|;|:|( )?<| [a-z])";
		String regexEvento = "(( [IVX]{1,5})?( ConferÍncia| Evento| Show| Concerto| SimpÛsio| Debate| FÛrum| Estudo) ((e )?(de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |no |nos |nas |na |para )?[A-Z¬¡… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)(\\. |, | - | )?)+(\\s*(-|/)\\s*[A-Z][A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]+)*)(,|\\Q.\\E|;|:|<| [a-z])";
		...
		String regexInfoEmp = " estabelecida n(a|o) ([0-9A-Za-zÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«\\Q() ,∫∞™-.;/'\"\\E]+ CNPJ(/MF)? n(∫|∞) \\d{2}\\.\\d{3}\\.\\d{3}/\\d{4}-\\d{2} e CACEPE n(∞|∫) \\d{7}\\-\\d{2})";
		...
		String regexMunicipio = "( (M|m)unicÌpio)( de)?( [A-Z¬¡¿… Õ”‘⁄][A-Za-zÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«]+)+";
		String regexCargo = "(( Primeiro| Segundo| Terceiro| (1|2|3)(∫|∞|™))?( Auditor| Comandante( Geral)?| Chefe(s)?| Sargent(o|a)| Tenente(s)?| Subtenente(s)?| (\\QTenente\\E( |-))?Corone(l|Èis)| Cabo(s)?| Capit„(o)?(s)?| Major| Secret·ri(o|a)| PresidÍncia| Diretor(\\-Presidente|\\-Geral)?| Agente(s)?| Gerente(s)?| Assistente(s)?| Assessor(a|es|as)?| Superintendente(s)?| Coordenador(a|as|es)?| Gestor(es|a|as)?) ((e )?(de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |no |nos |nas |na |para |com os |com as )?(<ORG>)?[A-Z¬¡… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)(</ORG>)?(, | - | )?)+)(,|\\Q.\\E|;|:| [a-z]|( )?<)";
		String regexCargo2 = "( Delegad(o|a)(s)?| Escriv(„o|„es)| Agente(s)?| Diretor(es|a|as)?| Assessor(a|as|es)?| Gestor(a|as|es)?| Coordenador(es|a|as)?)(,| [a-z ]{1,8}[^A-Z]|\\.)";
		String regexImp = "(( Õndice| Taxa| Imposto| Tributo) (((e )?(de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |no |nos |nas |na |para )?[A-Z¬¡… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)(\\. |, | - | )?))+(\\s*(-|/)\\s*[A-Z]([A-Z¬√¡… Õ”‘’⁄«&]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙&]+))*)(,|\\Q.\\E|;|:)";
		...
		//JO√O, PRESTAR ATEN«√O DE P‘R TAGS QUE PODEM SER VISTAS AO PROCURAR UM MATCH DE UM TIPO
		//Padrıes e Matchers
		...
		Pattern padraoOrgao2 = Pattern.compile(regexOrgao2);
		...
		tiposDocumentos.put("Di·rio Oficial da Uni„o", "DOU");
		tiposDocumentos.put("Di·rio Oficial do Estado", "DOE");
		//n„o t· pegando
		tiposDocumentos.put("Ordem Banc·ria", "OB");
		tiposDocumentos.put("Ordens Banc·rias", "OB");
		...
		for (int i = 0; i < anosDecretos.length; i++){
			...
			for (int j = 0; j < arquivos[i].length; j++){
				...
				try {
					...
					matcher = padraoOrgao2.matcher(decretoSaida);
					while (matcher.find()){
						//System.out.println(nomeArquivo);
						entreTags = matcher.group(1);
					...
					while (matcher.find()){
						//System.out.println(nomeArquivo);
						entreTags = matcher.group(0);
						textoModificado = " <SIST>" + matcher.group(0).trim() + "</SIST>";
						decretoSaida = decretoSaida.replaceFirst("\\Q" + entreTags +"\\E", textoModificado);			
					}
