...
public class XMLizacao {
	...
	public static void main(String[] args) {
		...
		String regexSecretaria = "(( |\"|\\()((?i)(Secretaria)|(?i)(Gabinete)) ((e )?(de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |no |nos |nas |na |para |com |com os |com as )?[A-Z¬¡¿… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)(, | - | )?)+(\\s*(-|/)\\s*[A-Z][A-Za-z\\QÁ„‡·‚ÈÍÌÛÙı˙¬√¡¿… Õ”‘’⁄«&\\E]+)*)\\s*(,|<|\\Q.\\E|;|:|\"|\\Q)\\E| [a-zÈ‡·ÌÛ˙Í‚Ù])";
		...
		String regexCargo = "[^(Unidades|Unidade|ComitÍ|Comiss„o)](( Primeiro| Segundo| Terceiro| (1|2|3)(∫|∞|™))?( Auditor| Comandante( Geral)?| Chefe(s)?| Sargent(o|a)(s)?| Tenente(s)?| Subtenente(s)?| (\\QTenente\\E( |-))?Corone(l|Èis)| Cabo(s)?| Capit„(o)?(s)?| Major| Secret·ri(o|a)| PresidÍncia| Diretor(\\-Presidente|\\-Geral)?| Agente(s)?| Gerente(s)?| Assistente(s)?| Assessor(a|es|as)?| Superintendente(s)?| Coordenador(a|as|es)?| Gestor(es|a|as)?) ((de |do |dos |da |das |‡ |a |ao |aos |pelo |pelos |pelas |pela |por |em |no |nos |nas |na |para |com |com os |com as )?(<ORG>)?[A-Z¬¡… Õ”‘⁄]([A-Z¬√¡… Õ”‘’⁄«]+|[a-zÁ„‡·‚ÈÍÌÛÙı˙]+)(</ORG>)?(, | - | )?)+)\\s*(,|<|\\Q.\\E|;|:|\"|\\Q)\\E| [a-zÈ‡·ÌÛ˙Í‚Ù])";
